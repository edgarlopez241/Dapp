...
const commonStyles = "min-h-[70px] sm:px-0 px-2 sm:min-w-[120px] flex justify-center items-center border-[0.5px] border-gray-400 text-sm font-ligth text-white";
            ...
            <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py12 px-4">
                 <div className="flex flex-1 justify-start flex-col mf:mr-10">
                    ...
                    <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
                       Explora el mundo Cripto. Compra y Vende Criptos Facilmente en SuperCrypto 
                    </p>
                   {!currentAccount && (<button
                    ...
                    >
                        <p className="text-white text-base font-semibold">Conecta tu Wallet</p>
                    </button>
                    )}
                    ...
                    <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
                        ...
                        <div className={commonStyles}> Tarifas Minimas</div>
                 ...
                 <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
                    <div className="p-3 justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card   ">
                        <div className="flex justify-between flex-col w-full h-full">
                            <div className="flex justify-between items-start">
                               ...
                               <div>
                                <p className="text-white font-ligth text-sm ">
                    ...
                    <Input placeholder="Direccion para enviar:" name="addresTo" type="text" handleChange={handleChange} />
                    <Input placeholder="Monto en Ethers:" name="amount" type="number"  handleChange={handleChange} />
