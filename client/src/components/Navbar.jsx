...
const Navbar = () =>{
    ...
    const NavBarItem = ({title,classProps})=>{
        return(
        <li className={`mx-4 cursor ${classProps}`}>
            {title}
        </li>
        );
}
    return(
        <nav className='w-full flex md:justify-center justify-between items-center p-4'>
            <div className='md-[0.5] flex-initial justify-center items-center'>
                ...
                <div className='flex relative'>
                      ...
                      {toggleMenu &&(
                        <ul
                            className='z-10 fixed top-0 -right-2 p-3 w-[70vw] h-screen md:hidden list-none
